...
function showUser(str) {
    if (str == "" || str=="0") {
        ...
        xmlhttp.open("GET","/getusers.php?q="+str+"&&t=com",true);
        xmlhttp.send();
    }
}
</script>
    ...
    <body>
        ...
        <?php if($mensaje!="" && $mensaje!="correcto"){ echo "<div class=\"alert alert-warning\"><strong>Error!</strong> ".$mensaje." </div>";} ?>
         <div id="alta">
            ...
            <h3>Agregar nuevo</h3>
             <form class="form-signin" method="post"  action="ABC_operaciones.php?t=comentario&&a=Agregar">
            Contenido   <textarea name="con" id="con"  class="form-control" cols="40" rows="5" ></textarea></br>
            Calificacion <input type="number"  name="cal"class="form-control" min="0" max="7" placeholder="5" required autofocus>
           ...
           <button class="btn btn-lg btn-primary btn-block" type="submit" >Crear</button></br>
            ...
            <h3>Modificar existente</h3>
             ...
             <form class="form-signin" method="post" action="ABC_operaciones.php?t=comentario&&a=Modificar">
            Prereserva: 
            ...
            $usuarios = mysqli_query($connection, 
                "CALL select_comentario") or die("Query fail: " . mysqli_error());
            ...
            <h3>Eliminar</h3>
              ...
              <form class="form-signin" method="post" action="ABC_operaciones.php?t=comentario&&a=Eliminar">
            Usuario: 
