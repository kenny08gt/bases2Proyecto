...
function showUser(str) {
    if (str == "" || str=="0") {
        ...
        xmlhttp.open("GET","/getusers.php?q="+str+"&&t=d",true);
        xmlhttp.send();
    }
}
</script>
    ...
    <body>
        ...
        <?php if($mensaje!="" && $mensaje!="correcto"){ echo "<div class=\"alert alert-warning\"><strong>Error!</strong> ".$mensaje." </div>";} ?>
         <div id="alta">
            ...
            <h3>Agregar nueva dimension</h3>
             <form class="form-signin" method="post"  action="ABC_operaciones.php?t=dimension&&a=Agregar">
            Nombre <input type="text"  name="nombre"class="form-control" placeholder="Precio" required autofocus>
           ...
           <button class="btn btn-lg btn-primary btn-block" type="submit" >Crear</button></br>
            ...
            <h3>Modificar existente</h3>
             ...
             <form class="form-signin" method="post" action="ABC_operaciones.php?t=dimension&&a=Modificar">
            Dimension: 
            ...
            <h3>Eliminar</h3>
              ...
              <form class="form-signin" method="post" action="ABC_operaciones.php?t=dimension&&a=Eliminar">
            Dimension: 
