...
function showUser(str) {
    if (str == "" || str=="0") {
        ...
        xmlhttp.open("GET","/getusers.php?q="+str+"&&t=es",true);
        xmlhttp.send();
    }
}
</script>
    ...
    <body>
        ...
        <?php if($mensaje!="" && $mensaje!="correcto"){ echo "<div class=\"alert alert-warning\"><strong>Error!</strong> ".$mensaje." </div>";} ?>
         <div id="alta">
            ...
            <h3>Agregar nueva </h3>
             <form class="form-signin" method="post"  action="ABC_operaciones.php?t=es&&a=Agregar">
            Establecimiento 
           ...
           <button class="btn btn-lg btn-primary btn-block" type="submit" >Crear</button></br>
            ...
            <h3>Modificar existente</h3>
             ...
             <form class="form-signin" method="post" action="ABC_operaciones.php?t=es&&a=Modificar">
            ...
            <?php
                 $connection = mysqli_connect("127.0.0.1", "ingeusac", "", "bases2", "3306");
                  //verificar si existe usuario
            $usuarios = mysqli_query($connection, 
                "CALL select_es") or die("Query fail: " . mysqli_error());
            ...
            <h3>Eliminar</h3>
              ...
              <form class="form-signin" method="post" action="ABC_operaciones.php?t=es&&a=Eliminar">
            Establecimiento - servicio
