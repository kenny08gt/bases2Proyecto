...
function showUser(str) {
    if (str == "" || str=="0") {
        ...
        xmlhttp.open("GET","/getusers.php?q="+str+"&&t=s",true);
        xmlhttp.send();
    }
}
</script>
        ...
        <?php if($mensaje!="" && $mensaje!="correcto"){ echo "<div class=\"alert alert-warning\"><strong>Error!</strong> ".$mensaje." </div>";} ?>
         <div id="alta">
            ...
            <h3>Agregar nuevo servicio</h3>
             <form class="form-signin" method="post"  action="ABC_operaciones.php?t=servicio&&a=Agregar">
           ...
           <button class="btn btn-lg btn-primary btn-block" type="submit" >Crear</button></br>
            ...
            <h3>Modificar existente</h3>
             ...
             <form class="form-signin" method="post" action="ABC_operaciones.php?t=servicio&&a=Modificar">
            Servicio: 
            ...
            <h3>Eliminar</h3>
              ...
              <form class="form-signin" method="post" action="ABC_operaciones.php?t=servicio&&a=Eliminar">
            Servicio: 
